...
import { available_sizes, available_colors } from '../components/search/SearchFilter'
...
class Brand extends Component {
    ...
    render() {
        ...
        const brandTitle = posts.slice(0, 1).map(p => p.brand)
