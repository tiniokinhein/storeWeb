                                ...
                                <div className="">
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            {
                                                item.checkout.contact.home_no &&
                                                <>{item.checkout.contact.home_no}<br /></>
                                            }
                                            {
                                                item.checkout.contact.street_quarter &&
                                                <>{item.checkout.contact.street_quarter}<br /></>
                                            }
                                            {
                                                item.checkout.contact.township &&
                                                <>{item.checkout.contact.township}<br /></>
                                            }
                                            <br />
                                        </p>
                                        <p
                                ...
                                >
                                    {
                                        item.products.orderItems.map((p, index) => (
                                            ...
                                            >
                                                ...
                                                >
                                                    <h6
                                                        className="m-0 pb-0 text-dark font-weight-bold"
                                                        style={{
                                                            fontSize: '14px'
                                                        }}
                                                    >
                                                        ...
                                                        <>
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    <Translation>
                                                                        {(t) => <>{t('main.color')}</>}
                                                                    </Translation> - <strong className="font-weight-bold">{p.color}</strong>
                                                                </small>
                                                            </p>
                                                            <p
                                                                className="mb-2"
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    <Translation>
                                                                        {(t) => <>{t('main.size')}</>}
                                                                    </Translation> - <strong className="font-weight-bold">{p.size}</strong>
                                                                </small>
                                                            </p>
                                                        </>
                                                    }
                                ...
                                <div className="d-none d-lg-flex p-4 bg-white">
                                    ...
                                    >
                                        <button
                                            ...
                                            className="btn d-block shadow-none py-2 w-100 text-light shop-btn text-uppercase rounded-0"
                                            style={{
                                                background: '#fe9902',
                                                height: '56px',
                                                whiteSpace: 'nowrap',
                                    ...
                                    <div
                                        className="buy-btn mt-0 w-50 float-left py-2 d-flex align-items-center justify-content-center text-light ml-2 btn-cart-hover"
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div
                                            className="rounded-0 shadow bg-white text-center py-5 px-4 font-weight-bold"
                                            style={{
                                                lineHeight: '2',
                                                fontSize: '22px',
                                                color: '#000',
                    ...
                    <div className="container">
                        ...
                        >
                            ...
                            >
                                <button
                                    onClick={() => this.props.history.push('/')}
                                    className="btn d-block shadow-none py-1 w-100 text-light shop-btn text-uppercase rounded-0"
                                    style={{
                                        background: '#fe9902',
                                        height: '40px',
                                        whiteSpace: 'nowrap',
                            ...
                            <div
                                className="buy-btn mt-0 w-50 float-left py-1 d-flex align-items-center justify-content-center text-light ml-2 btn-cart-hover"
                                onClick={() => this.props.history.push('/track')}
                                style={{
                                    background: '#000',
                                    cursor: 'pointer'
...
export default connect(mapStateToProps, { addOrder })(withRouter(CompletedOrder))