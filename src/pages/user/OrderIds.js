...
class OrderIds extends Component {
    _isMounted = false
    ...
    changeStatusPending = () => {
        ...
        db
            .ref(ORDERURL + `/${id}`)
            .update(newStatus, () => {
                this.props.history.push('/order-cancellations')
            })
    }

    openModal = () => {
        document.getElementById('delete_setting').style.transform = "scale(1.0)"
        document.getElementById('delete_setting').style.opacity = "1"
    }

    closeModal = () => {
        document.getElementById('delete_setting').style.transform = "scale(0.0)"
    ...
    render() {
        ...
        const pendingID = p ? p.status === 'Pending' : null
        // const cancelledID = p ? p.status === 'Cancelled' : null
            ...
            <div className="position-absolute" id="delete_setting" style={deleteCss}>
                <div className="text-right">
                    <button
                        ...
                        className="btn bg-custom text-white text-center p-0 shadow-sm"
                        style={{
                            width: '35px',
                            height: '35px',
                            lineHeight: '0',
                ...
                <button
                    className="btn bg-white border-0 shadow text-default px-3 py-1 btn-cart-hover"
                    style={{
                        lineHeight: '1.5',
                        height: '35px',
                        fontSize: '0.8rem',
                    ...
                    onClick={this.changeStatusPending}
                >
                    <Translation>
                        {(t) => <>{t('main.order.cancelled')}</>}
                    </Translation>
                </button>
            </div>
                                ...
                                <div className="">
                                    ...
                                    >
...

                                        {
                                            ...
                                            >
                                                <span
                                                    className="d-inline-block px-2 bg-default text-white shadow-sm"
                                                    style={{
                                                        borderRadius: '2px'
                                                    }}
                                                >
                                                ...
                                                <span
                                                    className="d-inline-block px-2 text-muted"
                                                >
                                                    <Translation>
                                                        {(t) => <>{t('main.pending')}</>}
                                                    </Translation>
                                                ...
                                                >
                                                    <button
                                                        ...
                                                        className="btn bg-custom border-0 text-white text-center p-0 shadow-sm"
                                                        style={{
                                                            width: '35px',
                                                            height: '35px',
                                                            lineHeight: '0',
                                        ...
                                        {/* {
                                            ...
                                            >
                                                <span
                                                    className="d-inline-block px-2 bg-danger text-white shadow-sm"
                                                    style={{
                                                        borderRadius: '2px'
                                                    }}
                                                >
                                                ...
                                                <span
                                                    className="d-inline-block px-2 ml-1 text-danger"
                                                >
                                                    <Translation>
...

                                        {
                                            ...
                                            >
                                                <span
                                                    className="d-inline-block px-2 bg-success text-white shadow-sm"
                                                    style={{
                                                        borderRadius: '2px'
                                                    }}
                                                >
                                                ...
                                                <span
                                                    className="d-inline-block px-2 ml-1 text-success"
                                                >
                                                    <Translation>
...
export default withRouter(OrderIds)